...
class UsuarioService{
    ...
    let usuarios: [Usuario] = [
        ...
        Usuario(id: 103, nome: "Sandra Souza", idade: 24, match: false, frase: "Acho q a gente combina", foto: "pessoa-1"),
        ...
        Usuario(id: 101, nome: "Gabriela Santos", idade: 23, match: true, frase: "Adoro filmes", foto: "pessoa-3"),
